...
![image-20230118213454392](/images/grammar_note/image-20230118213454392.png)

### 用于不定冠词

要使用不定冠词 `a` 还是 `an`，取决于名词「第一个字母」或「第一个音节」的**发音**：
...
| **词缀**  | **解释**                                   | **例子**                                      |
| ----- | -------------------------------------- | ----------------------------------------- |
| -ion  | 构成**名词**，表“状态，动作”等         | reaction <br />transition <br />cooperation |
| -ness  | 构成**抽象名词**                     | faintness n.微弱              |
| -ment  | 构成**抽象名词**                     | acknowledgement n.承认；感谢          |
| -ence  | 构成**抽象名词**                     | circumfer**ence** n.圆周<br />depend**ence** n.依靠<br />insist**ence** n.坚持 |
| -ian   | 构成**名词**，表示人 | statistician n.统计员      |
| -ance  | 构成**名词**，表”**性质，状态**“                 | appear**ance** n.出现；外表<br />resembl**ance** n.相似<br />disturbance n.扰乱 |
| -er   | 构成**名词**，动词的执行者 | teenager n.青少年<br />tanker n. 油罐车   |
| -or | 构成**名词**，动词的执行者 | actor n.演员<br />tractor n.拖拉机<br />refrigerator n.冰箱<br />doctor n.医生 |
| -ess   | 构成**名词**，表示**女性**，雌性 | headmistress n.女校长<br />goddess n.女神<br />actress n.女演员 |
| -ent   | 构成**名词** | compentent<br />student<br />president n.总统（preside 主持） |
| -ary   | 构成**名词**；表”人，场所，物“ | Summary n.总结<br />library n.图书馆<br />salary<br />secretary n.秘书 |
| -ism  | 构成**名词**，表”主义(宗教)，行为，特征“等                | mannerism n.言行举止<br />buddhism n.佛教<br />optimism n.乐观主义 |
| -ics  | 构成**名词**，对...的研究，”学科，学术“               | pediatrics n.小儿科<br />economics n.经济学<br />mechanics n.机械学<br />physics n.物理学 |
| -logy  | 构成**名词**，...学, ...术            | psychology n.心理学<br />ecology n.生态学<br />geology n.地质学<br />biology n.生物学<br />sociology n.社会学<br />mythology n.神话学 |
...
### 2. 不定冠词
**泛指**人和物，表示一个，后面加**单数可数名词**辅音发音前面加a，元音发音前面加an
...
1. 先行词和引导词之间有**介词**，用 **which（物**）或 **whom（人）**
2. **非限定性定语从句**用 **which** 不用 that
---

1. 先行词有人也有物时，用 **that** 不用 who
2. 先行词指【物】且含有**不定代词**时用**that**。(all, little, few, much, everything, anything, nothing, one, none等)
3. 先行词含有**最高级**或含有**序数词**时用**that**
4. 当主句是以【who】,【which】**开头**的特殊疑问句或先行词是【who】时用**that**
   1. **Which** is the book **that** he bought yesterday?
   2. **Who** **that** you have ever seen can beat him in the game?先行词被 **same** 修饰，且指“同一物体”时，用 **that**
5. She is wearing the **same** dress **that** she wore yesterday.
6. 先行词在主句中**作表语**，用 **that**
   1. This **is** no longer the place **that** it used to be. （这已经不是以前的样子了）
   2. He **is** not the **man** **that** he was. （他已经不是过去的他了）
   3. Shanghai **is** no longer the **city** **that** it used to be. (上海不再是曾经的那个城市了)
7. 主句是 **there be** 句型且关系词在从句中做主语，用 **that**
   1.  There is a seat **that** is still available.
...
【analysis】**out team has won the prize**对**news**起到内容说明的作用，故本题考察同位语从句，故选 A
</details>
...
#### 翻译技巧
[https://www.bilibili.com/video/BV1ov411r7L6](https://www.bilibili.com/video/BV1ov411r7L6)

Q：什么是定语？
A：中文翻译为 xxx 的词（定语就是形容词）

Q：什么是定语从句？
A：连词+句子，作形容词修饰名词

##### 定语从句的位置问题
中文里面，定语在名词前面（eg.漂亮的女孩）
英语里面，定语：

1. 单个词的，一般放名词前，除了：
   1. 不形：不定代词+形容词
   2. a 形：something important a boy asleep. 
   3. 过去分词（前后都行）
2. 从句，后置
...
![image-20221104191401729](/images/grammar-note/image-20221104191401729.png)
...
【analysis】显然是使用 So do I 的否定形式：**Neither do I**，情态动词 do 可以根据前句进行判断，将【Tom doesn't have his own room】转换为一般疑问句：【**Doesn't** Tom have his own room?】由此可见助动词是**doesn't**，也就是 **do** 的三单否定形式，而 **have** 为实义动词，故选 B
</details>
...
原：We take the class in this room.
强：**It is** in this room **that** we take the class.

### 如何证明一个句子是强调句

把标志it is/was ... that/who 去掉，仍是**正确的句子**就是强调句。
...
| 将来 | 用过去时或 **should do**或 **were to do** | 用 【would、should、could、might】+ **动词原形**   |
...
- 对**过去**虚拟：用**过去完成时**had done

- 对**将来**虚拟：用**过去时**或 **should do** 或 **were to do**
...
在“**It is (high/about) time + that 从句**”句型中，从句谓语动词多用**过去式**，也可以用“**should + do**”，并且 should 不可省略
...
【**without（如果没有）, but for（要不是）,but (that)（要不是）， otherwise（否则）, under（按照）**】，用**主句**的虚拟规则
...
进行**补充说明**，让句子更加的**精确客观**，对句子进行**强调**，进行**过度转折**
...
- **不能多**
- 一句话当中只能有一个动词，并且充当谓语，多余的动词全部都要变成**非谓语动词**。
...
##### 4. 谓语的总结
一句话当中，**有且只能有一个**有时态的实义动词或系动词的存在，并且充当谓语。
##### 谓语练习
...
2. **there be**句型，听到“有”的时候使用。
   1. **There exist** a host of undergraduates being fascinated with me.
3. **!!!被动**：当听到一句话没有主语，或者人称代词做主语的时候，都可以考虑写成被动
   1. 必须指出坚持很重要 => Persistence must be pointed out outstandingly crucial.
   2. 越来越多的人认为过度捕捞很严重 => Overfishing is claimed more than fearful by an increasing amount of professors.
...
1. 所有写不来的长难句，暂时都先写成简单句，一定要保证语法正确。
2. 所有不会写的单词，都可以写成自己会的词汇


#### 长难句分析

1. 找谓语动词，找主谓宾
2. 有多个动词时找主句的动词，前面没有引导词的动词就是主句的动词
...
### 考点分析
#### 写作
只要写作的上下句之间有关系，就一定要用逻辑关系词（连词、副词、介词和介词短语）
练习写句子：
...
#### 长难句分析
在分析长难句的时候，只要有并列连词的出现，通常都会有省略
分析长难句的第二步就是找连词，但是在连词连接两个单词的时候，这个连词就装作没看见，无论何时
...
1. The movies looks terrific（充当**主语**）
2. I admine his mother （充当**宾语**）
3. Gump is a man（充当**表语**）
4. I enjoy the part, the beginning.（充当**同位语**）
...
1. **That**: 当从句是陈述句时。并且 That 在从句中不充当任何成分，也没有任何意思。
2. **Whether**: 当从句是一般疑问句时。并且 Whether 在从句中也不充当成分，意思是“是否”。
...
6. It keeps my  argument that...

主语从句的满分句型，可以写在作文中任何一句话前面
练习：
...
##### 同位语从句
The matter that he managed to find a girlfriend makes his superiours rejoiced.
同位语从句既可以放在它所解释的名词后，也可以放在整句话的后面。
